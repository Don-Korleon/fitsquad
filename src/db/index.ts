 ...
 * stateless serverless instances (same reasoning as setPendingAction above) — this protects
 * costly AI calls (OpenAI photo verification, coach tips, motivation) from being spammed.
 */
